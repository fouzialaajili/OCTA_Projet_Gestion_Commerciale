namespace OCTA_Projet_Gestion_Commerciale.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DeviseSocieteId = c.Long(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.GEN_Tier", "IdDeviseDefault", "dbo.GEN_Devise");
            ...
            DropForeignKey("dbo.GEN_Tier", "CPT_CodesTVA_Id", "dbo.CPT_CodesTVA");
            ...
            DropForeignKey("dbo.GEN_Model", "GEN_Dossiers_DossierId", "dbo.GEN_Dossier");
            ...
            DropIndex("dbo.GEN_Tier", new[] { "CPT_CodesTVA_Id" });
            ...
            DropIndex("dbo.GEN_Model", new[] { "GEN_Dossiers_DossierId" });
