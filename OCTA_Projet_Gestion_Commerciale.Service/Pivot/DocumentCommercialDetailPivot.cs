...
{
    public class DocumentCommercialDetailPivot
    {
...
public int DocumentCommercialDetailCodeLiaison { get; set; }
        ...
        public ArticlePivot DocumentCommercialDetailArticle { get; set; }
        public  long? DocumentCommercialIdDocumentCommercial { get; set; }
      public DocumentCommercialPivot DocumentCommercialDetailDocumentCommercial { get; set; }
        public  ICollection<DocumentCommercialDetailSeriePivot> DocumentCommercialDetailDocumentCommercialDetailSerie { get; set; }
