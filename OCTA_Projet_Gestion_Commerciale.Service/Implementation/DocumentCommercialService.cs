...
namespace OCTA_Projet_Gestion_Commerciale.Service.Implementation
{
    public class DocumentCommercialService : IDocumentCommercialService
    {
        ...
        {
           documentCommercialRepository.Delete(documentCommercial.DocumentCommercialId,Mapper.Map<DocumentCommercialPivot, GES_DocumentCommercial>(documentCommercial));
        }
