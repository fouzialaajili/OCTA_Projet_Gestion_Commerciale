    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.CPT_CodesTVA", t => t.CPT_CodesTVA_CodeTVADefault_Id)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.GES_Devise", t => t.IdDeviseDefault)
                ...
                .ForeignKey("dbo.GES_Representant", t => t.GES_Representant_RepresentantId)
                .ForeignKey("dbo.GEN_TypePaiement", t => t.TypeTiers)
                .ForeignKey("dbo.CPT_CodesTVA", t => t.TvaSocieteId, cascadeDelete: true)
                .Index(t => t.TypeTiers)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.GES_Devise", t => t.IdDevise)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CPT_CompteG", t => t.CPT_CompteG_Id)
                .ForeignKey("dbo.GES_Devise", t => t.GEN_Devises_DevisesId)
                .ForeignKey("dbo.GEN_Dossier", t => t.GEN_Dossiers_DossierId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.GES_Devise", t => t.IdDeviseTC)
                .ForeignKey("dbo.GES_Devise", t => t.IdDeviseTR)
                .ForeignKey("dbo.GEN_Dossier", t => t.IdDossier)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.GES_Devise", t => t.IdDeviceTC)
                .ForeignKey("dbo.GES_Devise", t => t.IdDeviceTR)
                .ForeignKey("dbo.GEN_DossiersSites", t => t.IdDossierSite)
                .ForeignKey("dbo.GEN_Tier", t => t.IdDossierSite)
                .Index(t => t.IdPiece)
                .Index(t => t.IdCompteG)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.GES_Devise", t => t.OpportuniteIdDevise)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.GEN_Tier", "TvaSocieteId", "dbo.CPT_CodesTVA");
            DropForeignKey("dbo.GES_Reglement", "ReglementBanqueId", "dbo.GEN_Tier");
            DropForeignKey("dbo.GES_Reglement", "ReglementDossierId", "dbo.GEN_Dossier");
            DropForeignKey("dbo.GES_FournisseurArticle", "FournisseurArticleIdfournisseur", "dbo.GEN_Tier");
            ...
            DropForeignKey("dbo.GEN_Tier", "TypeTiers", "dbo.GEN_TypePaiement");
            ...
            DropForeignKey("dbo.GEN_Tier", "GES_Representant_RepresentantId", "dbo.GES_Representant");
            ...
            DropForeignKey("dbo.GES_Ticket", "TicketIdClient", "dbo.GEN_Tier");
            ...
            DropForeignKey("dbo.GES_TicketDetail", "TicketDetailIdcommercial", "dbo.GEN_Tier");
            DropForeignKey("dbo.GEN_TiersContacts", "IdTiers", "dbo.GEN_Tier");
            ...
            DropForeignKey("dbo.GEN_Tier", "IdDeviseDefault", "dbo.GES_Devise");
            DropForeignKey("dbo.CPT_ComptesBancairesTiers", "IdTiers", "dbo.GEN_Tier");
            DropForeignKey("dbo.CPT_ComptesBancairesTiers", "IdDevise", "dbo.GES_Devise");
            DropForeignKey("dbo.GES_OpportuniteDetail", "OpportuniteDetailIdopportunite", "dbo.GES_Opportunite");
            DropForeignKey("dbo.GES_OpportuniteDetail", "OpportuniteDetailIdcommercial", "dbo.GEN_Tier");
            ...
            DropForeignKey("dbo.GES_Opportunite", "OpportuniteIdDevise", "dbo.GES_Devise");
            DropForeignKey("dbo.GES_Devise", "GEN_Dossiers_DossierId", "dbo.GEN_Dossier");
            DropForeignKey("dbo.GES_Devise", "DevisesIdDossier", "dbo.GEN_Dossier");
            ...
            DropForeignKey("dbo.CPT_ComptesBancaires", "GEN_Devises_DevisesId", "dbo.GES_Devise");
            DropForeignKey("dbo.CPT_RelevesBancaires", "IdDevise", "dbo.GES_Devise");
            ...
            DropForeignKey("dbo.CPT_Journaux", "GEN_Devises_DevisesId", "dbo.GES_Devise");
            DropForeignKey("dbo.CPT_Pieces", "IdTiers", "dbo.GEN_Tier");
            DropForeignKey("dbo.CPT_Pieces", "IdDossierSite", "dbo.GEN_DossiersSites");
            DropForeignKey("dbo.CPT_Pieces", "IdDossier", "dbo.GEN_Dossier");
            DropForeignKey("dbo.CPT_Pieces", "IdDeviseTR", "dbo.GES_Devise");
            DropForeignKey("dbo.CPT_Pieces", "IdDeviseTC", "dbo.GES_Devise");
            DropForeignKey("dbo.CPT_Pieces", "IdJournal", "dbo.CPT_Journaux");
            DropForeignKey("dbo.CPT_Ecritures", "IdDossierSite", "dbo.GEN_Tier");
            ...
            DropForeignKey("dbo.CPT_Ecritures", "IdDeviceTR", "dbo.GES_Devise");
            DropForeignKey("dbo.CPT_Ecritures", "IdDeviceTC", "dbo.GES_Devise");
            ...
            DropIndex("dbo.GES_Devise", new[] { "GEN_Dossiers_DossierId" });
            DropIndex("dbo.GES_Devise", new[] { "DevisesIdDossier" });
